...
def getColorInfo(l: list):
    ...
    cleanColorInfo["purple"] = dirtyColorInfo["color05"]
    ...
    cleanColorInfo["brightYellow"] = dirtyColorInfo["color11"]
    cleanColorInfo["brightBlue"] = dirtyColorInfo["color12"]
    cleanColorInfo["brightPurple"] = dirtyColorInfo["color13"]
    ...
    cleanColorInfo["cursorColor"] = dirtyColorInfo["color_foreground"]
